...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
  {
   ...
   [_CT] = LAYOUT(
	  DF(_LB), DF(_MB), KC_NO,   M(3),    M(4),    M(5),    M(6),    M(7),    M(8),    M(9),    KC_MUTE, KC_VOLD, KC_VOLU, TERM_ON,  TERM_OFF,
   ...
   [_MF] = LAYOUT(
	  ...
	  KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_HOME, KC_PGUP, MF_DOIT,
	  KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   UC(241), KC_NO,   KC_NO,   KC_END,  KC_PGDN, KC_UP,   KC_CAPS,
	  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSPC, KC_TRNS, KC_TRNS, KC_LEFT, KC_NO,   KC_DOWN, KC_RGHT),
  };
